...
class StatisticsTests(unittest.TestCase):
    ...
    def test_render_outcome_dataframe_uses_native_sortable_dataframe_for_summary_rows(self):
        ...
        self.assertEqual(column_config["Capturable Revenue Potential per Year"]["width"], 285)
        self.assertEqual(column_config["Calculated Revenue per Year"]["width"], 230)
        self.assertEqual(column_config["Theoretical Max Revenue"]["width"], 210)
        self.assertEqual(column_config["Total Repeat Purchases"]["width"], 170)
