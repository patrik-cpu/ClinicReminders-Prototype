...
class VisualThemeCssTests(unittest.TestCase):
    ...
    def test_stats_page_folds_outcomes_and_actioning_tabs(self):
        ...
        self.assertIn('STATS_SENT_REMINDER_PERIODS = ["Today", "Past week", "Past month", "Past year", "All-time", "More", "Calendar", "Custom"]', source)
        self.assertIn('STATS_MORE_ROLLING_PERIODS = ["Past 3 months", "Past 6 months", "Past 2 years"]', source)
